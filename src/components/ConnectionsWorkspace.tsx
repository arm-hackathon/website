...
export default function ConnectionsWorkspace() {
  ...
  return (
    <main className="app-shell connections-page">
      <SiteChrome activePage="connections" syncState={syncState} editorAccess={editorAccess} />
